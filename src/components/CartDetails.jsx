...
const CartDetails = () => {
    ...
    const handleDecrement = (e) => {
        ...
        toast.success("Hey! Item Remove From Your Cart")
    }
    ...
    const emptycart = () => {
        ...
        toast.success("Hey! Your Cart is Empty.")
                    ...
                    <div className="card">
                        <div className="card-header bg-dark p-3">
                            <div className="card-header-flex">
                                <h5 className="text-white m-0">Cart Total {carts.length > 0 ? `(${carts.length})` : ""}</h5>
                                {
                                                ...
                                                return (
                                                    <>
                                                        <tr>
                                                            ...
                                                            <td><div className='product-name'><p>
                                                                {data.dish}
                                                            </p></div></td>
                                                            <td>
                                                                {data.price}
